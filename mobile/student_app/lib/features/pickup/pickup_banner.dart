...
/// user is the student. Polls every 15 s and disappears when no calls
/// are active. Wrap your home Scaffold's body with a Column containing
/// this widget on top.
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    const Text('ولي أمرك في انتظارك',
                        style: TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
                            fontSize: 16)),
                    Text(
                      '${c['parent_name']} عند ${c['gate'] ?? 'البوابة'} · منذ ${c['waited_min']} دقيقة',
